...
class BottomSheetWorkspaceItem extends StatelessWidget {
  const BottomSheetWorkspaceItem({
      ...
      child: Row(
        children: [
          Icon(
            Icons.work_outline,
            color: _isSelected
                ? appTheme.colors.unselectedLabel
                : appTheme.colors.defaultTrailingIcon,
            size: _workIconSize,
          ),
          const SizedBox(
